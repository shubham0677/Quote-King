 ...
 */
public class RelationshipQuotes extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        this.listView=(ListView) findViewById(R.id.listViewRel);
        DatabaseAccess databaseAccess=DatabaseAccess.getInstance(this);
        databaseAccess.open();
        List<String> mquotes=databaseAccess.getQuotes7();
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent=new Intent(RelationshipQuotes.this,QuoteInfo.class);
