 ...
 */
public class FriendshipQuotes extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        this.listView=(ListView) findViewById(R.id.listViewfrnd);
        DatabaseAccess databaseAccess=DatabaseAccess.getInstance(this);
        databaseAccess.open();
        List<String> mquotes=databaseAccess.getQuotes5();
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent=new Intent(FriendshipQuotes.this,QuoteInfo.class);
